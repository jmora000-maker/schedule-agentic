...
# This module handles the generation of risk explanations and actionable recommendations using Large Language Models (LLMs).
# It leverages the OpenAI API to generate explanations and recommendations based on the provided evidence.
# The goal of this module is to provide context-aware insights and recommendations for risk triage.
# It uses a system prompt to guide the LLM in generating actionable recommendations based on the provided evidence.
# The system prompt is designed to be flexible and adaptable to different project scenarios and risk signals.
# It is crafted to be concise, clear, and focused on providing actionable recommendations based on the evidence provided.
# The module also includes fallback mechanisms in case of LLM errors or inability to generate explanations.
# The module is designed to be modular and extensible, allowing for different LLM models and different explanations.
# 1. Generate risk explanations based on evidence
# 2. Generate actionable recommendations based on risk explanations
# 3. Provide context-aware insights and recommendations for risk triage
