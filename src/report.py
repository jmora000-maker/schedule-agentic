...
# --- REPORT GENERATION ---
# This module handles the generation of structured schedule-risk reports.
# It organizes findings by milestone and signal type, ranks findings based on severity, and formats findings for display.
# The goal of this module is to provide a structured and actionable report of schedule-related risks.
