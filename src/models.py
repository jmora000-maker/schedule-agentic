...
# --- DATA MODELS FOR PIPELINE INPUTS AND OUTPUTS ---
# These classes define the data structures used throughout the pipeline.
# They are used to represent the input and output data of various stages in the pipeline.
# The goal of these classes is to provide a clear and consistent way to represent the data.
...
class EvidenceItem(BaseModel):
    source_type: str = Field(..., description="e.g. task_update, issue, delivery_note, rag_chunk")
